		...
		<div class="row banner-text">
			<div class="slider-info col-lg-6">,
				<div class="agileinfo-logo mt-lg-5 pt-md-3">
					<h2>A simpler way to verify & transfer <br>land ownership.</h2>
					<p>The journey of owning a property starts with title verification. Homefy digital platform allows you<br>to search & purchase properties easily.</p>
				</div>
				<a class="btn mr-2 text-capitalize" href="#popup1">Start the Journey </a>
				<a class="btn text-capitalize" href="#popup2">Learn More</a>
			</div>
			<div class="col-lg-6 col-md-8 mt-lg-0 mt-5 banner-image text-center">
				<img src="images/verification.svg" alt="" class="img-fluid"/>
				<!-- <h4 class=" mt-3 text-white text-center">Get a Land to Build Your Dream House </h4> -->
			</div>
		</div>
	</div>
</div>
...
<section class="choose bg-light py-5">
	<div class="container py-md-3">
		<h3 class="heading mb-5"> Why Homefy</h3>
		<div class="feature-grids row">
			<div class="col-lg-4 col-sm-6">
				<div class="f1 bg-white icon1 p-4">
					<img class="svgIcons" src="images/data.svg" >
					<!-- <span class="fa fa-building"></span> -->
					<h3 class="my-3">Property Matching Accuracy</h3>
					<p>Our Homefy Matching Index helps homebuyers find verified properties that suits their preferences.</p>
				</div>
			</div>
			<div class="col-lg-4 col-sm-6 mt-sm-0 mt-4">
				<div class="f1 bg-white icon2 p-4">
					<img class="svgIcons" src="images/finance.svg" >
					<h3 class="my-3">Flexible Finance Option</h3>
					<p>We provide you with a 50% Loan to help finance your property purchase easily at zero interset rate.</p>
				</div>
			</div>
			<div class="col-lg-4 col-sm-6 mt-lg-0 mt-4">
				<div class="f1 bg-white icon3 p-4">
					<img class="svgIcons" src="images/title.svg" >
					<h3 class="my-3">Title Registration</h3>
					<p>We help you process & transfer ownership of property documents easily at a cheap and fixed cost.</p>
				</div>
			</div>
...
<section class="choose bg-light py-5">
	<div class="container py-md-3">
		<h3 class="heading mb-5">Top Rated Properties</h3>
		<div class="feature-grids row">
			<div class="col-lg-4 col-sm-6">
				<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<img class="card-img-bottom" src="images/land.jpg" alt="Card image cap">
						</div>
						<div class="detail">
							<h4 class="title mb-2"><a href="contact.html">Estate Town In Los vegas</a></h4>
							<ul class="facilities-list clearfix">
								...
								<li>
									<span class="fa fa-building"></span> Sq Ft : 3400
								</li>
								<li>
									<span class="fa fa-building"></span> 1 Garage
								</li>
							</ul>
							<p class="mt-2">Integer pulvinar leo id viverra feugiat. Et Pellentesque libero justo.</p>
						</div>
				</div>
			</div>
			<div class="col-lg-4 col-sm-6 mt-sm-0 mt-4">
	...
	<div class="container py-md-3">
		...
		<div class="row process-grids">
			<div class="col-lg-3 col-md-6 my-lg-4 w3pvt-ab position-relative">
				<div class="">
					<h4 class="feed-title my-3">Step 1</h4>
					+
				</div>
			...
			<div class="col-lg-3 col-md-6 my-lg-4 mt-md-0 mt-4 w3pvt-ab position-relative">
				<div class="">
					<h4 class="feed-title my-3">Step 2</h4>
			...
			<div class="col-lg-3 col-md-6 my-lg-4 mt-sm-5 mt-4 w3pvt-ab position-relative">
				<div class="">
						<h4 class="feed-title my-3">Step 3</h4>
			...
			<div class="col-lg-3 col-md-6 mt-lg-4 mt-sm-5 mt-4 w3pvt-ab">
				<div class="">
					<h4 class="feed-title my-3">Step 4</h4>
...
<section class="video bg-light py-5" id="video">
	<div class="container">
		<div class="inner-sec-w3ls py-lg-5 py-3">
			<div class="row">
				<div class="col-lg-6">
					<h3 class="tittle-w3">Let’s guide you through the process</h3>
					<p class="mt-4">Our team of experienced real estate advisors are available to guide you through the nuances of purchasing your first property, be it a land or house.</p>
				</div>
				<div class="col-lg-6">
					<img src="images/customercare.jpg" alt="">
				</div>
			</div>
		</div>
	</div>
...
<section class="partners py-5" id="partners">
	<div class="container py-md-3">
		<h3 class="heading text-white mb-5">Our Trusted Partners</h3>
...
<footer class="footer-emp-w3ls py-5">
	...
	<div class="copy-right-top border-top mt-4">
		<p class="copy-right text-center pt-xl-5 pt-4">&copy; 2020 Homefy. All Rights Reserved
		...
		<div class="login px-sm-4 mx-auto mw-100">
			...
			<form action="#" method="post">
				...
				<div class="form-group">
					...
					<input type="password" class="form-control" id="exampleInputPassword1" href="/dashboard" placeholder="" required="">
				</div>
				<button type="submit" class="btn btn-primary submit mt-2" href="/dashboard">Login</button>
...
<!-- popup for register -->
<div id="popup4" class="popup-effect" style="margin-top:-130px;">
	<div class="popup">
		<div class="login px-sm-4 mx-auto mw-100">
			<h5 class="text-center mb-4" style="margin-top:-30px">Register Now</h5>
			<form action="#" method="post" style="margin-top:-30px;">
				...
				<p class="text-center mt-3" style="margin-top:-100px">
